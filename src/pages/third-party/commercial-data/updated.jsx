...
const API_UPDATE = (thirdPartyId) => ['api', 'v1', 'commercial-data', thirdPartyId];
 ...
 * @param {Function} props.onSuccess - Callback invocado tras actualizacion exitosa.
...
const UpdatedCommercialData = ({
    ...
    /**
     * Envia el formulario de actualizacion al backend.
    ...
    const handleUpdate = async () => {
        try {
            ...
            await fetchHelper.put(
                base_url(API_UPDATE(commercialData.thirdPartyId)),
                payload,
                {},
                1000
            );
            ...
            console.error('Error al actualizar datos comerciales:', error);
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title fw-bold">Actualizar Datos Comerciales</h4>
...
export default UpdatedCommercialData;

...
const UpdateDepreciationRules = ({ modalRef, modalInstance, menuPermission, setMenuPermission, dataTableRef, setMenuUpdate }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            const url = base_url(['api', 'menu-permissions', 'update']);
            await fetchHelper.put(url, menuPermission, {}, 1000);
            setMenuPermission({
                id: '',
                menu_id: '',
                role_id: '',
...
export default UpdateDepreciationRules;
...
const CurrencyCreated = ({ dataTableRef, modalRef, modalInstance, currency, setCurrency, setMessage }) => {
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title" id="modalCenterTitle">Agregar Tipo de Moneda</h4>
                        <button
                            type="button"
                            className="btn-close"

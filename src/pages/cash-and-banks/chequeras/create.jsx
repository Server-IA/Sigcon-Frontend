...
const CreateCheckbook = ({
    ...
    const validate = () => {
        ...
        const obsErr = validateText(record.observations, { min: 0, max: 500, patternKey: 'descriptionSemicolon', label: 'Las observaciones' });
        if (obsErr) { nextErrors.observations = obsErr; valid = false; }

...
const EXTRAVIADO_URL = (id) => ['api', 'v1', 'cash-and-banks', 'cheques', id, 'extraviado'];
...
const LostCheque = ({
    ...
    const [form,         setForm]         = useState({ fechaExtravio: today, tipoIncidente: '', detalleIncidente: '', accionesTomadas: '' });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await fetchHelper.put(url, {
                fechaExtravio:    form.fechaExtravio,
                tipoIncidente:    form.tipoIncidente,
                detalleIncidente: form.detalleIncidente.trim(),
                accionesTomadas:  form.accionesTomadas?.trim() || null,
            }, {}, 1000);
                        ...
                        <div className="row">
                            <div className="col-md-6 mb-4 mt-2">
                                <InputModal
                                    ...
                                    value={form.fechaExtravio}
                                    onChange={(e) => setForm(prev => ({ ...prev, fechaExtravio: e.target.value }))}
                                    error=""
                                    required
                                />
                            </div>
